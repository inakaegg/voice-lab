...
set_default_runpod_app_env() {
  ...
  export MO_RUNPOD_PRELOAD_FUNASR_ON_START="${MO_RUNPOD_PRELOAD_FUNASR_ON_START:-0}"
  export MO_RUNPOD_RELEASE_VOICE_CONVERSION_BEFORE_FUNASR="${MO_RUNPOD_RELEASE_VOICE_CONVERSION_BEFORE_FUNASR:-1}"
  export MO_RUNPOD_RELEASE_FUNASR_BEFORE_VOICE_CONVERSION="${MO_RUNPOD_RELEASE_FUNASR_BEFORE_VOICE_CONVERSION:-1}"
  export MO_AUDIO_HISTORY_ENABLED="${MO_AUDIO_HISTORY_ENABLED:-0}"
  export OPENAI_ASR_MODEL="${OPENAI_ASR_MODEL:-gpt-4o-transcribe}"
  export OPENAI_TRANSLATION_MODEL="${OPENAI_TRANSLATION_MODEL:-gpt-5.6-terra}"
  ...
  export FUNASR_MODEL="${FUNASR_MODEL:-funasr/paraformer-zh}"
  export FUNASR_FA_MODEL="${FUNASR_FA_MODEL:-funasr/fa-zh}"
  export FUNASR_VAD_MODEL="${FUNASR_VAD_MODEL:-funasr/fsmn-vad}"
  export FUNASR_PUNC_MODEL="${FUNASR_PUNC_MODEL:-funasr/ct-punc}"
  export FUNASR_HUB="${FUNASR_HUB:-hf}"
  export FUNASR_DEVICE="${FUNASR_DEVICE:-cuda}"
