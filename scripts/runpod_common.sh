...
set_default_runpod_app_env() {
  ...
  export MO_RUNPOD_RELEASE_FUNASR_BEFORE_VIBEVOICE="${MO_RUNPOD_RELEASE_FUNASR_BEFORE_VIBEVOICE:-1}"
  ...
  export MO_VIBEVOICE_DIRECTED_ASR_PROVIDER="${MO_VIBEVOICE_DIRECTED_ASR_PROVIDER:-openai}"
  export MO_VIBEVOICE_DIRECTED_OPENAI_ASR_MODEL="${MO_VIBEVOICE_DIRECTED_OPENAI_ASR_MODEL:-whisper-1}"
  export MO_VIBEVOICE_DIRECTED_ASR_LANGUAGE="${MO_VIBEVOICE_DIRECTED_ASR_LANGUAGE:-auto}"
  export MO_VIBEVOICE_DIRECTED_VC_ENABLED="${MO_VIBEVOICE_DIRECTED_VC_ENABLED:-1}"
  export MO_VIBEVOICE_DIRECTED_VC_BACKEND="${MO_VIBEVOICE_DIRECTED_VC_BACKEND:-seed-vc}"
