...
function SpeakLoop() {
  return <PageShell className="practice-shell react-practice-shell">
    ...
    <section className="practice-quick-settings react-toolbar" aria-label="練習設定"><label className="practice-current-language practice-language-select"><span>学習言語</span><select id="practice-target-language-select" aria-label="学習する言語"><option value="zh-CN">🇨🇳 中文</option><option value="en-US">🇺🇸 English</option></select></label><label id="practice-pinyin-setting" className="practice-inline-setting" hidden><input id="practice-pinyin-toggle" type="checkbox" defaultChecked/><span>ピンイン</span></label></section>
