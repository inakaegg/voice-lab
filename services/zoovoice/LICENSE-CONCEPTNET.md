...
2. 片方の端点だけがZoovoiceの動物aliasへ一致するedgeを残す。
...
| `alias_sha256` | 変換に使った動物alias定義のSHA-256 |
...
この条件はデータベースとその内容だけに適用する。Zoovoiceのコード、CC0の音源素材、whisper.cppとモデルには適用しない。リポジトリ本体の権利は [LICENSE](../../LICENSE)、その他の第三者成果物は [THIRD_PARTY_NOTICES.md](../../THIRD_PARTY_NOTICES.md) を参照する。
