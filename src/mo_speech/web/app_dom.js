const form = document.querySelector("#audio-workbench-form");
const audioInput = document.querySelector("#audio");
const audioLabel = document.querySelector("#audio-label");
const audioSelectionStatus = document.querySelector("#audio-selection-status");
...
const referenceAudioSelectionStatus = document.querySelector("#reference-audio-selection-status");
...
const vcOnlyElements = [...document.querySelectorAll(".vc-only")];
