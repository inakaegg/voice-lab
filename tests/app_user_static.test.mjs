...
test("vibevoice simple page hides advanced controls behind fixed practical defaults", () => {
  ...
  assert.doesNotMatch(vibevoiceSimpleHtml, /id="vibevoice-reference-url"/);
  assert.doesNotMatch(vibevoiceSimpleHtml, /id="vibevoice-reference-url-dialog"/);
  assert.doesNotMatch(vibevoiceSimpleHtml, /data-reference-url-open-slot="1"/);
  assert.doesNotMatch(vibevoiceSimpleHtml, /data-reference-url-display-slot="1"/);
  assert.doesNotMatch(vibevoiceSimpleHtml, />URL<\/button>/);
